      ...
      <v-col>
        <table>
          <tr>
            ...
            <td :class="pointType === 'rank7' || pointType === 'rank14' ? 'text-h4' : ''" style="width:auto">
...
import { pointTypeTierCountDic, Review, ReviewFactorParam, ReviewFunc, ReviewPointType } from '@/common/review'
